...
function applyGrow(
  ...
  for (const [x, y] of cells) {
    // One nutrient check per cell — GROW costs the same as base sim (1 charge),
    // not 1 charge per extra spawn. This makes GROW beneficial rather than self-defeating.
